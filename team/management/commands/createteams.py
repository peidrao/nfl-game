...
TEAMS = [
    ...
    {'name': 'Las Vegas Raiders', 'stadium': 'Allegiant Stadium', 'logo': 'oakland-raiders.png', 'division': 'West', 'tag': 'AFC' },
    ...
    {'name': 'Los Angeles Chargers', 'stadium': 'SoFi Stadium', 'logo': 'los-angeles-chargers.png', 'division': 'West', 'tag': 'AFC' },
    ...
    {'name': 'Green Bay Packers', 'stadium': 'Lambeau Field', 'logo': 'green-bay-packers.png', 'division': 'North', 'tag': 'NFC' },
